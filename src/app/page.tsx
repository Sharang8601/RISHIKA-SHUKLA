...
export default function HomePage() {
  useEffect(() => {
    ...
    gsap.fromTo(
      ".hero-title-line",
      { y: "100%" },
      { y: "0%", duration: 1.2, ease: "power4.out", stagger: 0.15, delay: 0.2 }
    );
    ...
    // 2. Hero Image Expanding Mask Reveal
    gsap.fromTo(
      ".hero-img-container",
      { clipPath: "polygon(0 0, 0 0, 0 100%, 0 100%)" },
      { clipPath: "polygon(0 0, 100% 0, 100% 100%, 0 100%)", duration: 1.4, ease: "power4.inOut", delay: 0.3 }
    );
    ...
    // 3. Featured Card Reveal (Curtain clip-path on scroll)
    gsap.fromTo(
    ...
    // Parallax on featured card image
    gsap.fromTo(
      ".featured-img",
      { yPercent: -15 },
      {
    ...
    // 4. Explore Topics Header & Grid Stagger
    gsap.fromTo(
      ".topics-title",
      { opacity: 0, y: 30 },
      {
    ...
    // 5. Latest Writings Staggered entry
    gsap.fromTo(
      ".latest-title-block",
      { opacity: 0, y: 35 },
      {
    ...
    // 6. Behind the Words biography reveal
    gsap.fromTo(
      ".about-text-content",
      { opacity: 0, x: -50 },
      {
  ...
  return (
    <>
      ...
      <section className="max-w-container-max mx-auto px-margin-mobile md:px-gutter pt-stack-lg pb-section-gap grid grid-cols-1 md:grid-cols-2 gap-stack-lg items-center min-h-[819px]">
        <div className="flex flex-col gap-stack-md text-left">
          <h1 className="font-display-lg-mobile md:font-display-lg text-display-lg-mobile md:text-display-lg text-on-background">
            <span className="block overflow-hidden relative">
              <span className="block hero-title-line">Hi, I'm Rishika 👋</span>
            </span>
            <span className="block overflow-hidden relative">
              <span className="block hero-title-line text-primary">Writer, Dreamer &amp; Storyteller.</span>
            </span>
          </h1>
          <p className="hero-para font-body-lg text-body-lg text-on-surface-variant max-w-lg mt-stack-sm">
          ...
          <div className="flex gap-stack-md mt-stack-md">
            <Link 
              className="hero-btn bg-primary text-on-primary px-8 py-3 rounded-full font-label-md text-label-md hover:bg-primary-container transition-colors shadow-sm text-center" 
              href="/blogs"
            >
              Read Blogs
            </Link>
            <Link 
              className="hero-btn border border-outline px-8 py-3 rounded-full font-label-md text-label-md text-on-background hover:bg-surface-container-low transition-colors text-center" 
              href="/about"
            >
              About Me
            </Link>
        ...
        <div className="hero-img-container overflow-hidden rounded-xl border border-surface-variant shadow-[0_4px_20px_rgba(0,0,0,0.04)] relative w-full aspect-[4/5] md:aspect-square">
          <img 
      ...
      {/* Featured Section */}
      <section className="featured-section bg-surface-container-low py-section-gap px-margin-mobile md:px-gutter">
        <div className="max-w-container-max mx-auto">
          ...
          <div className="featured-card-wrapper rounded-xl overflow-hidden border border-surface-variant shadow-[0_4px_20px_rgba(0,0,0,0.04)] group hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition-shadow duration-300">
            <div className="grid grid-cols-1 md:grid-cols-12 items-center bg-surface-container-lowest overflow-hidden">
              <div className="md:col-span-7 h-[450px] overflow-hidden relative">
                <img 
                  className="featured-img absolute top-0 left-0 w-full h-[130%] object-cover group-hover:scale-102 transition-transform duration-700 ease-out" 
                  alt="Serene morning view" 
              ...
              <div className="md:col-span-5 p-stack-lg flex flex-col gap-stack-md text-left z-10">
      ...
      <section className="topics-section max-w-container-max mx-auto px-margin-mobile md:px-gutter py-section-gap">
        <h2 className="topics-title font-headline-md text-headline-md text-center mb-stack-lg">Explore Topics</h2>
        <div className="topic-grid grid grid-cols-2 md:grid-cols-4 gap-stack-md">
          {/* Category 1 */}
          <Link className="topic-card group relative aspect-square rounded-lg overflow-hidden border border-surface-variant shadow-sm hover:shadow-md transition-shadow" href="/blogs?category=Lifestyle">
            <div 
            ...
            <div className="absolute bottom-0 left-0 p-stack-md w-full text-left">
          ...
          {/* Category 2 */}
          <Link className="topic-card group relative aspect-square rounded-lg overflow-hidden border border-surface-variant shadow-sm hover:shadow-md transition-shadow" href="/blogs?category=Travel">
            <div 
              className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-110" 
          ...
          {/* Category 3 */}
          <Link className="topic-card group relative aspect-square rounded-lg overflow-hidden border border-surface-variant shadow-sm hover:shadow-md transition-shadow" href="/blogs?category=Books">
            <div 
              className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-110" 
          ...
          {/* Category 4 */}
          <Link className="topic-card group relative aspect-square rounded-lg overflow-hidden border border-surface-variant shadow-sm hover:shadow-md transition-shadow" href="/blogs?category=Self-Growth">
            <div 
              className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-110" 
      ...
      {/* Latest Articles */}
      <section className="latest-section max-w-container-max mx-auto px-margin-mobile md:px-gutter py-section-gap" id="blogs">
        <div className="latest-title-block flex justify-between items-end mb-stack-lg border-b border-surface-variant pb-stack-md">
        ...
        <div className="article-grid grid grid-cols-1 md:grid-cols-3 gap-stack-lg">
          {/* Article 1 */}
          <Link href="/blogs/minimalist-home" className="article-card group flex flex-col gap-stack-sm cursor-pointer text-left">
          ...
          {/* Article 2 */}
          <Link href="/blogs/old-town-corners" className="article-card group flex flex-col gap-stack-sm cursor-pointer text-left">
            <div className="aspect-[4/3] rounded-lg overflow-hidden border border-surface-variant mb-2">
              <img 
                className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" 
                alt="Old Town historic cafe" 
          ...
          {/* Article 3 */}
          <Link href="/blogs/daily-journaling" className="article-card group flex flex-col gap-stack-sm cursor-pointer text-left">
            <div className="aspect-[4/3] rounded-lg overflow-hidden border border-surface-variant mb-2">
              <img 
                className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" 
                alt="Fountain pen and paper" 
      ...
      {/* About Section */}
      <section className="about-section bg-surface-container py-section-gap px-margin-mobile md:px-gutter" id="about">
        <div className="max-w-container-max mx-auto grid grid-cols-1 md:grid-cols-2 gap-stack-lg items-center">
          <div className="about-text-content order-2 md:order-1 flex flex-col gap-stack-md text-left">
          ...
          <div className="about-img-frame order-1 md:order-2 relative aspect-[3/4] md:aspect-square max-w-md mx-auto w-full">
      ...
      {/* Newsletter Section */}
      <section className="newsletter-section max-w-container-max mx-auto px-margin-mobile md:px-gutter py-section-gap">
        <div className="newsletter-container bg-surface-container-low rounded-2xl p-stack-lg md:p-section-gap text-center border border-surface-variant shadow-[0_4px_20px_rgba(0,0,0,0.02)]">
